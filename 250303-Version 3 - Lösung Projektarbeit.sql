...
SELECT
			CASE
				WHEN forest_perc_2016 < 25 THEN 'q1 (<25%)'
				WHEN forest_perc_2016 BETWEEN 25 AND 50 THEN 'q2 (25-50%)'
				WHEN forest_perc_2016 BETWEEN 50 AND 75 THEN 'q3 (50-750%)'
				WHEN forest_perc_2016 > 75  THEN 'q4 (>75%)'
			END AS quartile,
...
--- Anfrage um die Top 3 Länder im 4. Quartal anzuzeigen

SELECT		forest_perc_2016,
			cn,
			region
FROM 		total_forest_perc
WHERE		forest_perc_2016 > 75
